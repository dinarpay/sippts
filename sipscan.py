...
class SipScan:
    ...
    def print(self):
        ...
        self.found.clear()
async def async_scan_with_timeout(targets, method, proto, user, domain, proxy=None, timeout=5):
    scan_tasks = []
    for target in targets:
        for port in range(5060, 5066):  # Example port range
            scan_task = async_scan_host_with_timeout(proto, target, port, method, user, domain, proxy, timeout)
